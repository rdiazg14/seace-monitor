> **Estado de producto (29 ago 2026):** el asesor #9/#10/#11 con iteraciones **1–11** está en prod (self-routing, funnel KV→PG, Dashboard conversión 30d). Punto de entrada: [TRASPASO_MAESTRO_SEACE.md](./TRASPASO_MAESTRO_SEACE.md). Foto: [ESTADO_CIERRE_2026-08-29.md](./ESTADO_CIERRE_2026-08-29.md). Changelog: [CHANGELOG_ITERACIONES.md](./CHANGELOG_ITERACIONES.md). Este PLAN sigue siendo el de **retrieval v2 + pipeline**; varias filas (reranker v2-m3, chunks 200–400, costo $0/mes, checklist Gemini, «sin caché de chat», clasificador híbrido) están **desactualizadas**. Si código y PLAN divergen, gana el código.
