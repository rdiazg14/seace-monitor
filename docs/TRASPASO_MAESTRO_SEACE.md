...
- Fases 4–6 (dual-write y DROP de `categoria_it`/`relevancia_ia`): **pendientes**. Moratoria `--forzar-completa` vigente (guard env).
...
- Capas fases 4–6: dual-write y DROP. Moratoria `--forzar-completa`.
